...
You can, however, safely delegate Atoms to validators in this phase by following the CLI guideline and video tutorial linked below. Of course, in the event of a state reversion, any earned fees and inflation may be lost. Note that only `bitcoivacli` should be used for making transactions. Voyager, the GUI for interacting with the Cosmos Hub, is currently in alpha and undergoing development. A separate announcement will be made once Voyager is safer for use.

CLI Guide 🔗:  [github.com/BITCOIVA/Bitcoiva-sdk/…/delegator-guide-cli.md](https://github.com/BITCOIVA/Bitcoiva-sdk/blob/develop/docs/bitcoiva/delegator-guide-cli.md) 
...
[ibc]: [https://github.com/BITCOIVA/Bitcoiva-sdk/blob/develop/docs/spec/ibc/overview.md]
