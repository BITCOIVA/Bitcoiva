...
import (
	...
	paramsclient "github.com/BITCOIVA/Bitcoiva-sdk/x/params/client"
...
const appName = "BitcoivaApp"

var (
	// default home directories for bitcoivacli
	DefaultCLIHome = os.ExpandEnv("$HOME/.bitcoivacli")

	// default home directories for bitcoivad
	DefaultNodeHome = os.ExpandEnv("$HOME/.bitcoivad")
...
// NewBitcoivaApp returns a reference to an initialized BitcoivaApp.
func NewBitcoivaApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	invCheckPeriod uint, baseAppOptions ...func(*bam.BaseApp)) *BitcoivaApp {
...
func (app *BitcoivaApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// application updates every end block
func (app *BitcoivaApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// application update at chain initialization
func (app *BitcoivaApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *BitcoivaApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *BitcoivaApp) ModuleAccountAddrs() map[string]bool {
