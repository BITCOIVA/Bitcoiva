...
func (app *BitcoivaApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *BitcoivaApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
