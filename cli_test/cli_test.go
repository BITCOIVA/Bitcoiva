...
func TestBitcoivaCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start bitcoivad server with minimum fees
...
func TestBitcoivaCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.BitcoivadHome, "config", "genesis.json")
...
func TestBitcoivaCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBitcoivaCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.BitcoivacliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestBitcoivadCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestBitcoivadAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
